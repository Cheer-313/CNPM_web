...
<div class="home-app">
    ...
    <div class="container-app">
            <h1 class="heading-table-app">Tên bảng</h1>
            <div class="header-btn-add">
                <button class="btn-add-table">Thêm</button>
            </div>
            <table class="table-app" border="1" style="border-color: #333;">
                <tr class="table-row-app" style="background-color: #f18415a6; height: 44px; font-size: 1.6rem;">
                    <th class="table-title-app">Cột 1</th>
                    <th class="table-title-app">Cột 2</th>
                    <th class="table-title-app">Cột 3</th>
                    <th class="table-title-app"></th>
                </tr>

                <!-- Dữ liệu -->
                <tr class="table-row-app" style="background-color: #efc0d69c; min-height: 36px;">
                    <td class="table-data-app"></td>
                    <td class="table-data-app"></td>
                    <td class="table-data-app"></td>
                    <td class="table-data-button table-data-app">
                        <button class="btn-delete-row">Xóa</button>
                        <button class="btn-update-row">Sửa</button>
                    </td>
                </tr>
                <tr class="table-row-app" style="background-color: #efc0d69c; min-height: 36px;">
                    <td class="table-data-app"></td>
